...
export default function EmpoweringEducationSection() {
  return (
    <section className="bg-[#f9f9f9] w-full py-6 md:py-8 relative overflow-hidden">
        ...
        <div className="flex flex-col gap-8 md:gap-10 lg:gap-[42px] items-center justify-start">
          ...
          <div className="relative w-full">
            ...
            <div className="relative flex flex-col md:flex-row gap-4 md:gap-6 lg:gap-[21px] items-stretch justify-center max-w-6xl mx-auto">
              ...
              <div className="flex-1 bg-white px-4 md:px-6 py-4 md:py-6 lg:py-[27px] min-h-[140px] md:min-h-[160px] lg:min-h-[180px] flex flex-col justify-between shadow-sm rounded-lg md:rounded-none">
              ...
              <div className="flex-1 bg-white px-4 md:px-6 py-4 md:py-6 lg:py-[27px] min-h-[140px] md:min-h-[160px] lg:min-h-[180px] flex flex-col justify-between border-b-[3px] md:border-b-[4px] lg:border-b-[5px] border-[#ff8829] shadow-sm rounded-lg md:rounded-none">
                <div className="flex flex-col gap-2 md:gap-3 lg:gap-4">
                  <h3 className="font-['Plus_Jakarta_Sans'] font-semibold text-xl md:text-2xl lg:text-[30px] text-black tracking-[-1.2px] leading-tight">
                    Schools/Principals
                  </h3>
